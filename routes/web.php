...
Route::get("/admin/category/{id}/delete","Admin\CategoryController@destroy");//مش ضمن كنسترولر اللارافيل عشان هيك نعملو لحالو
Route::get("/admin/category/active/{id}","Admin\CategoryController@active");//نفس اللي فوقو
